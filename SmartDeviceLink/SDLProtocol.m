        ...
        case SDLFrameInfoEndServiceNACK: {
            if (nakMessage.header.version >= 5) {
                ...
                if (rejectedParams.count > 0) {
                    SDLLogE(@"%@ Service NAK'd, service type: %@, rejectedParams: %@", (nakMessage.header.frameData == SDLFrameInfoStartService ? @"Start" : @"End"), @(nakMessage.header.serviceType), rejectedParams);
                }
            }
        } break;
